...
const admin = () => {
  ...
  let pubSub = new PubSub();
	const testSubscriber1 = (topics, data) => console.log("sub1" + ": " + topics + data);
  const testSubscriber2 = (topics, data) => console.log("sub2" + ": " + topics + data);
  const testSubscriber3 = (topics, data) => console.log("sub3" + ": " + topics + data);
