...
import { c as createCommonjsModule } from './main.js';
import { a as codemirror } from './codemirror-47f0ad4d.js';
...
var asn_1 = createCommonjsModule(function (module, exports) {
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
var clojure = createCommonjsModule(function (module, exports) {
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
var ebnf = createCommonjsModule(function (module, exports) {
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
var vim = createCommonjsModule(function (module, exports) {
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
var semaShowHint = createCommonjsModule(function (module, exports) {
// Based on: https://codemirror.net/doc/manual.html#addon_show-hint 
...
(function(mod) {
    ...
    function Widget(completion, data) {
      ...
      var ownerDocument = this.ownerDocument = cm.getInputField().ownerDocument;
      ...
      descriptions.className = "CodeMirror-hints " + theme;
      descriptions.style.maxWidth = "250px";
      descriptions.style.maxHeight = "170px";
      descriptions.style.paddingLeft = "17px";
      descriptions.style.paddingRight = "17px";
      descriptions.style.wordWrap = "break-word";
      descriptions.style.position = "absolute";
      ...
      this.updateDescriptionContent(completions[0]);
    ...
    Widget.prototype = {
      close: function() {
        ...
        if (this.descriptions.parentNode) this.descriptions.parentNode.removeChild(this.descriptions);
      ...
      changeActive: function(i, avoidWrap) {
        ...
        this.updateDescriptionContent(this.data.list[this.selectedHint]);
      },
      ...
      getDescriptionText: function(completion){
        var descText = "";
        if(completion.description){
          descText += `${completion.description}`;
          descText += '<br><br>';
        }
        if(completion.arguments){
          var args = completion.arguments.split(";");
          var argsText = `<ol>${args.map(a => `<li>${a.trim()}</li>` ).join("")}</ol>`;
          descText += `<b>Arguments:</b> ${argsText}`;
          descText += '<br>';
        }
      ...
      updateDescriptionPos: function() {
        this.descriptions.style.left = (this.hints.offsetLeft + this.hints.offsetWidth) + "px";
        this.descriptions.style.top = (this.hints.offsetTop) + "px";
      },
  
      updateDescriptionContent: function(completion) {
        this.descriptions.innerHTML = "";
        var descriptionTextElem = this.ownerDocument.createElement("p");
        descriptionTextElem.innerHTML = this.getDescriptionText(completion);
        this.descriptions.appendChild(descriptionTextElem);
      }
    };
...
//# sourceMappingURL=codeMirrorPlugins-47b81358.js.map
