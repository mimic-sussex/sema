...
var grammar = {
    ...
    {"name": "Function", "symbols": ["Oscillator", "_", (lexer.has("lparen") ? {type: "lparen"} : lparen), "_", "Function", "_", (lexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": d => ({ "@rec": [d[0]].concat(d[4])})},
