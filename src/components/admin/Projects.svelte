			...
			{#each Array(projectLoadStep) as _, i}
				<tr class="record-entry">
					<td>
						...
						<ContentLoader primaryColor='#404040' secondaryColor='#ccc' speed={0.4+(i*0.1)} width="350" height="16">
					...
					<td>
						<div class='loading-bar'>
						<ContentLoader primaryColor='#404040' secondaryColor='#ccc' speed={0.4+(i*0.1)} width="16" height="16">
					...
					<td>
						<div class='loading-bar'>
						<ContentLoader primaryColor='#404040' secondaryColor='#ccc' speed={0.4+(i*0.1)} width="50" height="16">
					...
					<td>
						<div class='loading-bar'>
						<ContentLoader primaryColor='#404040' secondaryColor='#ccc' speed={0.4+(i*0.1)} width="90" height="16">
