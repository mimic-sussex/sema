...
var grammar = {
    ...
    {"name": "Function", "symbols": ["IOFunc", "_", (lexer.has("add") ? {type: "add"} : add), "_", "Function"], "postprocess": d => [{ "@add": [ Object.assign({}, d[0]) ].concat(d[4])}]},
    {"name": "Function", "symbols": ["OscFunc"]},
    {"name": "Function", "symbols": ["IOFunc"]},
    {"name": "IOFunc", "symbols": ["Transducer"], "postprocess": d => ({"@io": d[0]})},
