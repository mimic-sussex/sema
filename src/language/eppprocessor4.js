...
var grammar = {
    ...
    {"name": "Expression", "symbols": [(lexer.has("paramBegin") ? {type: "paramBegin"} : paramBegin), "Params", (lexer.has("pipe") ? {type: "pipe"} : pipe), (lexer.has("funcName") ? {type: "funcName"} : funcName)], "postprocess": d => ({ "@synth": {"@params":d[1], "@jsfunc":d[3], "paramBegin":d[0], "paramEnd":d[2]}} )},
