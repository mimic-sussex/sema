...
var grammar = {
    ...
    {"name": "Params$subexpression$2", "symbols": [(lexer.has("oscAddress") ? {type: "oscAddress"} : oscAddress)]},
    {"name": "Params", "symbols": ["Params$subexpression$2"], "postprocess": (d) => ([{"@oscaddr":d[0][0]}])},
    ...
    {"name": "Params", "symbols": [(lexer.has("oscAddress") ? {type: "oscAddress"} : oscAddress), (lexer.has("separator") ? {type: "separator"} : separator), "Params"], "postprocess": d => [{ "@oscaddr": d[0]}].concat(d[2])},
