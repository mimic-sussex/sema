...
import MMLLSTFT from './MMLLSTFT.js'
...
// function MMLLOnsetDetector(sampleRate = 44100, threshold = 0.34){

class MMLLOnsetDetector{


	constructor(sampleRate = 44100, threshold = 0.34){
...
export default MMLLOnsetDetector;
// export { MMLLOnsetDetector };